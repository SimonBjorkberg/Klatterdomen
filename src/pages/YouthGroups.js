    ...
    <div class="youth-groups pt-[80px] w-[90%] md2:w-[800px] mx-auto">
      <div className="mt-10">
        ...
        <p class="text-lg">
          ...
          Grupper både för nybörjare och för de som klättrat ett tag och vill ha
          mer avancerad träning. På träningarna får man klättra, träna och ha
          roligt tillsammans med andra jämnåriga. Grupperna hålls av erfarna
          ledare som lär ut olika klättertekniker för att utvecklas och bli en
          bättre klättrare.
        </p>
      </div>
      <div>
        <p class="text-lg mt-5">
          ...
          rabatt i butiken. Vi har ett stort utbud av klätterutrustning från
          flera olika märken för både inomhus- och utomhusklättring.
        </p>
      </div>
      <section>
        <div class="collapse bg-base-200 mt-2">
          ...
          <div class="collapse-content bg-primary text-white peer-checked:bg-secondary peer-checked:text-white">
            <div class="text-lg">
              <h1 class="text-xl font-bold mt-4">Barngrupper Lördag/Söndag</h1>
              <p class="mb-4">
                Start för höstterminen är V.38, 23-24 sept. <br /> Uppehåll:
                V.44, 4-5 nov. <br /> Sista klättringen är helgen V.48, 2-3 dec.
              </p>

              <h1 class="text-xl font-bold">Ungdomsgrupper Måndag/Onsdag</h1>
              <p>
                Start V.39, måndag 25 sept. och onsdag 27 sept. <br /> Uppehåll:
                V.44, måndag 30 okt. och onsdag 1 nov. <br /> Sista klättringen
                för måndag är V.49, 4 dec. <br /> Sista klättringen för onsdag
                är V.51, 20 dec. <br /> Obs: Man kan ej ta igen missade
                tillfällen!
              </p>
            </div>
          </div>
            ...
            <div class="my-4 text-xl">
              ...
              <div>
                <p>
                  ...
                  kan man göra i samband med att man anmäler sitt barn/ungdom.
                  <br />
                  Maila{" "}
          ...
          <div class="collapse-content bg-primary text-white peer-checked:bg-secondary-focus">
            <div class="my-4 text-xl">
              <p class="mb-5">
                ...
                <br />
                (12-14 år, topprepskortet endast giltigt under ungdomsträningen){" "}
                <br />
                Mer information nedan
              </p>
              <h2 class="font-bold mb-2">Måndag Ungdomsklättring 14 - 19 år</h2>
              <p class="mb-2">Antal gånger: 10 tillfällen</p>
